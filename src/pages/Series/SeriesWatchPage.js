            ...
            <div className="flex flex-col justify-between gap-10 container ">
                <div className="flex flex-col flex-grow text-white">
                    ...
                    <div className="flex flex-col flex-shrink-0 mt-5">
                        <span className="text-white md:text-[30px] text-[35px] font-semibold ">{movies?.name}</span>
                        <div className="flex md:text-md text-lg flex-row mt-5 text-tags gap-3">
                            ...
                            <span className="mr-3 flex flex-row">
                                ...
                                <span className="text-gray-400">{new Date(movies?.first_air_date).getFullYear()}</span>
                            </span>
                        </div>
                        <div className="md:mt-5 mt-8 gap-2 flex-nowrap">
                            <span className="md:text-xl text-2xl font-semibold">Overview season {season}</span>
                            <p className="text-gray-400 pr-4 md:text-md text-xl">{se?.overview}</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="vertical-scroll text-white w-full flex-shrink-0 rounded-lg md:flex-col ">
                    <SEChosing
                        seasonNumber={movies?.number_of_seasons}
                        id={movieId}
                        se={se}
                        season={season}
                        ep={ep}
