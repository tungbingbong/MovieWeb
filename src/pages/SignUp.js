...
const SignUpPage = () => {
    const schema = Yup.object({
        firstName: Yup.string().required('First name is required').max(10, 'Max 10 characters'),
        lastName: Yup.string().required('Last name is required').max(10, 'Max 10 characters'),
